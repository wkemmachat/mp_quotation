...
<div class="content-wrapper">
    ...
    <section class="content">
        {{--  <div class="row">  --}}
        <form action="{{ route('transfer_in.store_in')}}" method="post">
                                ...
                                <div class="register-box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group ">
                                                ...
                                                <input type="text" name="document_reference_id_show" disabled value="IN-{{ $now->format('d-m-Y-H-i-s') }}" maxlength="100" class="form-control pull-right" >
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Transfer In Data</h3>
                        </div>
    ...
    $(function(){
        ...
        $("#addRow").click(function(){
            ...
            var parentData   = '<tr>';
                ...
                parentData  += '<option value="{{ $product->id }}">{{ $product->productId }} : {{ $product->productName }}</option>';
